...
const ScaleWrapper = styled.div`
  ...
  @media (min-width: 320px) { transform: scale(1.2); }
  @media (min-width: 480px) { transform: scale(1.5); }
  @media (min-width: 768px) { transform: scale(1.8); }
  @media (min-width: 1024px) { transform: scale(2); }
  @media (min-width: 1440px) { transform: scale(2.5); }
`;
